...
interface DementorProps extends GameObjectProps {
    onAttacked: () => void;
}
export default function Dementor({ onAttacked, ...props }: DementorProps) {
    return <HostileNPC name="player" onAttacked={onAttacked} patrol {...props} />;
}
